...
base_dir = fileparts(fileparts(fileparts(which('R20291_challenge_analysis'))));
tbl = readtable(fullfile(base_dir, 'data', 'mouse', 'Scores', 'R20291_weights_long.xlsx'));
...
groups         = {'ST1-75', 'ST1-68', 'PBS'};
panel_titles   = {'ST1-75', 'ST1-68', 'PBS'};
